...
const services = [
  { id: 'haircut', name: 'Classic Haircut', duration: '45 min', price: '35 BGN' },
  { id: 'beard', name: 'Beard Trim', duration: '30 min', price: '25 BGN' },
  { id: 'shave', name: 'Hot Towel Shave', duration: '45 min', price: '40 BGN' },
  { id: 'combo', name: 'Hair & Beard Combo', duration: '75 min', price: '55 BGN' },
];
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={!date || !selectedTime || !selectedService || !selectedBarber}
            >
              Confirm Booking
            </Button>
          </div>
